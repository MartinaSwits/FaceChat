    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ccp.registerCarrierNumberEditText(phoneText);
            ...
            continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
                ...
                {
                    if(continueAndNextBtn.getText().equals("Submit")||checker.equals("Code send"))
                    {
                        ...
                        if (VerificationCode.equals(""))
                        {
                            ...
                            PhoneAuthCredential creadential=PhoneAuthProvider.getCredential(mVerificationId,VerificationCode);
        ...
        mCallbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                loadingBar.dismiss();
                Toast.makeText(RegistrationActivity.this, "Code has been Send to you", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congradulations", Toast.LENGTH_SHORT).show();
